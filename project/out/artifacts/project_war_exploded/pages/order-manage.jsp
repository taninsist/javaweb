...
<div class="container_default" id="main">
    <aside>
        ...
        <ul class="nav">
            ...
            <li class="glyphicon glyphicon-signal active"><a href="/find-order-by-page">订单管理</a></li>
...
<%--                </span>--%>
            ...
            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                ...
                <tr>
                    ...
                    <th class="text-center sorting">支付状态</th>
                ...
                <tbody>
                <form action="/batch-del-order" method="post" class="batch-form">
                    ...
                    <c:forEach items="${orderList}" var="order" varStatus="i">
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn bg-olive btn-xs"><a
                                        href="/to-edit-order?id=${order.id}">编辑</a>
                                </button>
                                <input value="${order.id}" type="hidden">
            ...
            <%--   删除   --%>
            <form method="post" action="/del-order" class="delUserForm">
            ...
            <nav aria-label="Page navigation">
                ...
                <form action="/find-order-by-page">
                    <ul class="pagination">
                        ...
                        <input name="q" value="${keyword}" style="position: relative;top: 2px;margin-left: 20px"
                               placeholder="商品名称 订单用户 订单时间 订单编号">
